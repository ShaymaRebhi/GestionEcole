	...
	<div class="card-body">
		<form method="POST" action="{{ route('Etablissement.update',$etablissement->id) }}" enctype="multipart/form-data">
			...
			<div class="row mb-3">
				...
				<div class="col-sm-10">
					<input type="text" name="NomEtablissement" class="form-control" value="{{ $etablissement->NomEtablissement }}" />
				</div>
			</div>
			<div class="row mb-3">
				<label class="col-sm-2 col-label-form">Type</label>
				<div class="col-sm-10">
					<input type="text" name="Type" class="form-control" value="{{ $etablissement->Type }}" />
				</div>
			</div>
            <div class="row mb-3">
